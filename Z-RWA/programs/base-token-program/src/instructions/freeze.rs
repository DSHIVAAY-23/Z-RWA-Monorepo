...
/// Function to freeze the accounts
///
/// Arguements:-
///   - token: token name
///
...
///
/// Emits freeze event
pub fn freeze(ctx: Context<FreezeUserAccount>, token: String) -> Result<()> {
    ...
    // Create the FreezeAccount struct for our context
...
pub struct FreezeUserAccount<'info> {
    ...
    /// CHECK: This is the user to be freezed
    #[account(mut)]
