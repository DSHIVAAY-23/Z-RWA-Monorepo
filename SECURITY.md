...
### A. SP1 ZK Circuits (Proof Generation)
The core compliance engine relies on SP1 to generate proofs of authorized participant status without revealing PII.
...
The Solana program acts as the ultimate source of truth, verifying the SP1 proofs and managing state.
...
* **Identified Gaps:** We currently lack rigorous fuzzing on the SP1 circuit inputs and formal verification of the Anchor account structs against edge-case CPIs.
